...
class CustomRole(models.Model):
    """
    HR/Admin-defined roles beyond the built-in system roles.
    """
...
class CompanyProfile(models.Model):
    """Company information shown on the Settings page."""
    ...
    allowed_wifi_ips = models.TextField(
        blank=True,
        default=(
            "182.191.93.131, 192.168.20.210, "
            "192.168.20.1, 26.251.229.52, "
            "127.0.0.1, ::1"
        ),
...
class User(AbstractUser):
    ...
    def can_see_all_departments(self):
        return (
            ...
            or (
                self.custom_role_id
                and self.custom_role.can_see_all_departments
            )
        )
    ...
    def can_manage_employees(self):
        return (
            self.can_see_all_departments
            or self.is_team_lead
            or (
                self.custom_role_id
                and self.custom_role.can_manage_employees
            )
        )
    ...
    def can_manage_payroll(self):
        return (
            ...
            or (
                self.custom_role_id
                and self.custom_role.can_manage_payroll
            )
        )
    ...
    def can_review_leaves_reports(self):
        return (
            ...
            or (
                self.custom_role_id
                and self.custom_role.can_review_leaves_reports
            )
        )
    ...
    def can_manage_tasks_all(self):
        return (
            ...
            or (
                self.custom_role_id
                and self.custom_role.can_manage_tasks_all
            )
        )
